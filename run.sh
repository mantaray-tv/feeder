...
torsocks vlc -I dummy /test.torrent vlc://quit --sout '#transcode{vcodec=h264,scale=Auto,acodec=aac,scodec=dvbs}:std{access=http,mux=ts,dst=http://localhost:8000/stream.ts}' &
while true; do
